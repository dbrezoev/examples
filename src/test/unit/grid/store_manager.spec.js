...
describe('testing store manager:', () =>{
  ...
  it('should get local storage instance with defined data subscriptions', done => {
    ...
    expect(manager.getDataStore() instanceof LocalStore).toBeTruthy();
    expect(manager.dataPropertySubscription).toBeDefined();
    expect(manager.dataCollectionSubscription).toBeDefined();
    done()
  });
  ...
  it('should get remote storage instance with undefined data subscriptions', done => {
    ...
    expect(manager.getDataStore() instanceof RemoteStore).toBeTruthy();
    expect(manager.dataPropertySubscription).toBeUndefined();
    expect(manager.dataCollectionSubscription).toBeUndefined();
